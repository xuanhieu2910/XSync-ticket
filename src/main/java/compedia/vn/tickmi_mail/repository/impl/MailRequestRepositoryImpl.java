...
import compedia.vn.tickmi_mail.repository.MailRequestRepositoryCustom;
        ...
        if (!CollectionUtils.isEmpty(result)) {
            for (Object[] obj : result) {
                ...
                if (isCheck.equals(1)) {
                    ...
                    dto.setEmailFrom(ValueUtil.getStringByObject(obj[15]) == null ? null : ValueUtil.getStringByObject(obj[15]) );
                    dto.setPassword(ValueUtil.getStringByObject(obj[16]) == null ? null : ValueUtil.getStringByObject(obj[16]));
                    dto.setEmailHost(ValueUtil.getStringByObject(obj[17]) == null ? null : ValueUtil.getStringByObject(obj[17]));
                    dto.setEmailPort(ValueUtil.getStringByObject(obj[18]) == null ? null : ValueUtil.getStringByObject(obj[18]));
                    response.add(dto);
                }
            }
        }
